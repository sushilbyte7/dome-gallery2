...
function buildItems(pool: (string | ImageItem)[], seg: number): Coord[] {
...
export default function DomeGallery({
  ...
  }, [segments, lockScroll, unlockScroll, enlargeTransitionMs, openedImageBorderRadius, grayscale, openedImageWidth, openedImageHeight]);
  ...
  useGesture(
    {
      onDragStart: ({ event }) => {
        ...
        const potential = (event.target as HTMLElement).closest?.('.item__image') as HTMLElement | null;
